 ...
 * A string data field named name for the stock’s 
 * name.; 
 ...
 *  A constructor that creates a stock 
 *  with the specified symbol and name;
 *  A method named getChangePercent() that returns the
 *   percentage changed 
 *  from previousClosingPrice to currentPrice. Make a UML 
 *  diagram for the class in the comments in the top of the 
 *  class, and then implement the class. Write a test program 
 *  that creates a Stock object with the stock symbol ORCL, the
 *   name Oracle Corporation, and the previous closing price of
 *   34.5. Set a new current price to 34.35 and display the
